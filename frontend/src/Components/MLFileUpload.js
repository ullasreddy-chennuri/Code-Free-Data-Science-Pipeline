...
function MLFileUpload({ f,setF,uploadStatus, setUploadStatus, columnNames, setcolumnNames, buttonDisabled, setbuttonDisabled}) {
  ...
  const handleUpload = async () => {
    ...
    console.log(file)
      const response = await fetch('http://localhost:5000/upload_models', {
        method: 'POST',
        body: formData,
        responseType: 'blob',
